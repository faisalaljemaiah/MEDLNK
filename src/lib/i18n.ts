...
const en = {
  ...
  "profile.emptyFollowing": "You're not following any cases yet — follow one to get updates as it evolves.",
  "profile.emptyPosts": "No cases shared yet.",
  "profile.signedOutGateBody": "Create a free account to read this clinician's cases.",
  "profile.signedOutGateCta": "Create account",
  ...
  "settings.deleteAccountWarning": "Your account and everything tied to it — posts, comments, messages, and reactions — will be deleted. You can restore it by signing back in within 30 days; after that, it's gone for good.",
  ...
  "settings.deleteAccountPermanently": "Delete account",
  ...
  "caseDetail.signedOutGateBody": "Create a free account to read this case.",
  "caseDetail.signedOutGateCta": "Create account",
  "caseDetail.signedOutGateSignIn": "Already have an account? Sign in",
...
const ar: Partial<Record<TranslationKey, string>> = {
  ...
  "profile.tabFollowing": "المتابَعة",
  "profile.emptyMarked": "لا شيء بعلامة بعد. 💡 🧠 ⚠️ على حالة وستُجمع هنا.",
  "profile.emptySaved": "لا توجد حالات محفوظة بعد.",
  "profile.emptyFollowing": "لا تتابع أي حالة بعد — تابع حالة لتصلك التحديثات مع تطورها.",
  "profile.emptyPosts": "لم تتم مشاركة أي حالات بعد.",
  "profile.signedOutGateBody": "أنشئ حسابًا مجانيًا لقراءة حالات هذا الطبيب.",
  "profile.signedOutGateCta": "إنشاء حساب",
  ...
  "settings.deleteAccountWarning": "سيتم حذف حسابك مع كل ما يرتبط به — منشوراتك وتعليقاتك ورسائلك وتفاعلاتك. يمكنك استعادته بتسجيل الدخول خلال 30 يوماً؛ بعد ذلك سيُحذف نهائياً.",
  ...
  "settings.deleteAccountPermanently": "حذف الحساب",
  ...
  "caseDetail.signedOutGateBody": "أنشئ حسابًا مجانيًا لقراءة هذه الحالة.",
  "caseDetail.signedOutGateCta": "إنشاء حساب",
  "caseDetail.signedOutGateSignIn": "لديك حساب بالفعل؟ سجّل الدخول",
