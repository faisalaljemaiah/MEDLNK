  ...
  return (
    ...
    >
      ...
      {/* Above the hashtags, not below: this is the feed's one "go read the
          ...
          right off the caption than after a row of tags. Purple, not this
          app's own teal accent, so it stands out from every other
          accent-colored control on the card. */}
