      ...
      <button
        ...
        className={
          following
            ...
            : "rounded-full bg-accent px-4 py-1.5 text-sm font-medium text-on-accent transition-[background-color,transform] duration-150 ease-out active:scale-95 disabled:opacity-60"
        }
      >
